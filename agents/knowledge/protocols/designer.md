...
4. Validate syntax is well-formed
5. Run `quorum tool blueprint_lint` on Blueprint
...
- Do NOT skip Domain Model for data-heavy tracks
- Do NOT generate Architecture without considering NFRs
