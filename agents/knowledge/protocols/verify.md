...
1. Read config — extract `consensus.trigger_tag`, `audit_submit` MCP tool
...
Compare `git diff --name-only` against Changed Files section. Flag undocumented changes and phantom claims.
