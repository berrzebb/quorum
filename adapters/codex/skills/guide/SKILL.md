---
name: quorum-guide
description: "Guide for writing evidence packages for the quorum watch file. Use when preparing code review submissions or addressing audit rejections. Triggers on 'how to submit evidence', 'evidence format', 'write evidence'."
model: codex
