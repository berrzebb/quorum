...
1. **Spawn scout agent** — read-only, thorough analysis (Opus):
   ...
   RTM format: `${CLAUDE_PLUGIN_ROOT}/core/templates/references/${locale}/traceability-matrix.md`
...
```bash
node "${CLAUDE_PLUGIN_ROOT}/core/tools/tool-runner.mjs" rtm_parse --path <rtm.md> --status open
node "${CLAUDE_PLUGIN_ROOT}/core/tools/tool-runner.mjs" rtm_merge --base <base.md> --updates '["wt1.md","wt2.md"]'
```
