...
Audit runner: `quorum audit` (fallback: `node platform/core/audit.mjs`)

Config: `platform/core/config.json` — `consensus.trigger_tag`, `agree_tag`, `pending_tag`, `consensus.roles`.
