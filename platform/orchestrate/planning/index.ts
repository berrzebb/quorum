...
// Contract negotiation — bilateral contract approval enforcement
export type { NegotiationContext } from './contract-negotiation.js';
export { validateNegotiation, approveWithNegotiation } from './contract-negotiation.js';
