 ...
 *
 * Shared utilities (safePath, walkDir, parseFile, runPatternScan, etc.)
 * live in tool-utils.mjs and are re-exported here for backward compatibility.
 *
...
// Re-export utilities for backward compatibility (other files import from tool-core.mjs)
export {
  PATTERNS,
  findEndLine,
  parseFile,
