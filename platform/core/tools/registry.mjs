...
// Reporting
import { toolDashboard } from "./dashboard/index.mjs";
...
export const TOOL_NAMES = [
  ...
  // Knowledge management
  "memory_write",
  // v0.7 Vault — session search + wiki search (replaced memory_recall, memory_search)
  "recall", "search",
  // Reporting
  "dashboard",
];
...
const TOOLS = [
  ...
  {
    name: "dashboard",
    description: "Generate a self-contained HTML dashboard from EventStore data. Shows trigger evaluations, audit verdicts, fitness scores, stagnation patterns, and learning suggestions.",
    inputSchema: {
      type: "object",
      properties: {
    ...
    execute: (args) => toolDashboard(args),
    async: true,
    category: "reporting",
  },
];
